...
// postinumerot
export const dfzip = await FileAttachment({"name":"../../data/dfzip.csv","mimeType":"text/csv","path":"../../_file/data/dfzip.3509e648.csv","lastModified":1741976027108,"size":2248858}, import.meta.url).csv({typed: true})
...
export const dfzip_aikasarja = await FileAttachment({"name":"../../data/dfzip_aikasarja.csv","mimeType":"text/csv","path":"../../_file/data/dfzip_aikasarja.3453e696.csv","lastModified":1741976029568,"size":26053665}, import.meta.url).csv({typed: true})
export const dfzip_region = await FileAttachment({"name":"../../data/dfzip_region.json","mimeType":"application/json","path":"../../_file/data/dfzip_region.a5e5af4a.json","lastModified":1741976032595,"size":26363210}, import.meta.url).json("typed")
