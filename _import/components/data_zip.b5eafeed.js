...
// postinumerot
export const dfzip = await FileAttachment({"name":"../../data/dfzip.csv","mimeType":"text/csv","path":"../../_file/data/dfzip.3509e648.csv","lastModified":1755244778490,"size":2248858}, import.meta.url).csv({typed: true})
...
export const dfzip_aikasarja = await FileAttachment({"name":"../../data/dfzip_aikasarja.csv","mimeType":"text/csv","path":"../../_file/data/dfzip_aikasarja.3453e696.csv","lastModified":1755244780376,"size":26053665}, import.meta.url).csv({typed: true})
export const dfzip_region = await FileAttachment({"name":"../../data/dfzip_region.json","mimeType":"application/json","path":"../../_file/data/dfzip_region.b105a54c.json","lastModified":1755244782752,"size":26363219}, import.meta.url).json("typed")
