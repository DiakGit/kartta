...
// ladataan datat
// indikaattorit
export const indicator_list = await FileAttachment({"name":"../../data/df_indicator_list.json","mimeType":"application/json","path":"../../_file/data/df_indicator_list.b73699d7.json","lastModified":1741976616117,"size":10701}, import.meta.url).json("typed");
//export const df = await FileAttachment("../data/df.json").json("typed");
export const df = await FileAttachment({"name":"../../data/df.csv","mimeType":"text/csv","path":"../../_file/data/df.d39c2513.csv","lastModified":1741976618043,"size":2398242}, import.meta.url).csv({typed: true});

export const df2 = df
//export const df_aikasarja = await FileAttachment("../data/df_aikasarja.json").json("typed");
export const df_aikasarja = await FileAttachment({"name":"../../data/df_aikasarja.csv","mimeType":"text/csv","path":"../../_file/data/df_aikasarja.d6897c57.csv","lastModified":1741976620923,"size":31089699}, import.meta.url).csv({typed: true});
export const region_levels = ["Kunnat", "Hyvinvointialueet"];
export const df_region = await FileAttachment({"name":"../../data/df_region.json","mimeType":"application/json","path":"../../_file/data/df_region.ae39e874.json","lastModified":1741976624079,"size":257003}, import.meta.url).json("typed");
export const df_kuntalist = await FileAttachment({"name":"../../data/df_kuntalist.json","mimeType":"application/json","path":"../../_file/data/df_kuntalist.7358a0aa.json","lastModified":1741976626069,"size":38624}, import.meta.url).json("typed");
